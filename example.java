...
public class example {
   ...
   static final String PASS = "osorio";
   ...
   try{
     ...
     //Your Task 1!
      ...
      //Your Task 6: insert all tuples into Table exam;
        ...
        ques3.executeQuery("SELECT DISTINCT driver_name FROM driver WHERE driver_name NOT IN (SELECT DISTINCT driver_name FROM exam AS e1 JOIN exam AS e2 ON e1.driver_ssn = e2.driver_ssn AND e1.exam_date > e2.exam_date AND e1.exam_score > e2.exam_score, driver d WHERE e1.driver_ssn = d.driver_ssn)");
